...
"""Bühlmann ZHL-16 tissue compartment constants.

Each constant set gives, per tissue compartment, the half-time (minutes) and
the Bühlmann a/b coefficients, separately for nitrogen and helium.
"""
...
class ZHL16Constants(NamedTuple):
    N_TISSUES: int
    N2_HALFTIMES: list[float]
    N2_A_VALUES: list[float]
    N2_B_VALUES: list[float]
    HE_HALFTIMES: list[float]
    HE_A_VALUES: list[float]
    HE_B_VALUES: list[float]
    ID: str = 'ZHL-16C-1a'


# ZHL-16A (source: Wikipedia)
...
# ZHL-16C, variant 1a (source: Bühlmann Tauchmedizin, 2002; via OSTC2)
